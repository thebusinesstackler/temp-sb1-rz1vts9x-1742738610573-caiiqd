...
import { 
  Shield, ChevronRight, FileText, Users, Clock, 
  Award, Target, Globe, Search, ArrowRight, MessageSquare,
  CheckCircle, Star, BarChart, Activity, Dna
} from 'lucide-react';
  ...
  const expertiseAreas = [
    {
      ...
      description: "Extensive experience in rheumatoid arthritis, lupus, and other autoimmune conditions",
      stats: {
        trials: 85,
        patients: "6,500+",
        sites: 200
    ...
    {
      title: "Immunotherapy",
      description: "Leading expertise in cancer immunotherapy and checkpoint inhibitors",
      stats: {
        trials: 65,
        patients: "4,000+",
        sites: 150
    ...
    },
    {
      ...
      description: "Comprehensive trials in IBD, psoriasis, and other inflammatory conditions",
      stats: {
        trials: 75,
        patients: "5,500+",
        sites: 180
    ...
    },
    {
      ...
      description: "Specialized trials in transplant immunology and rejection prevention",
      stats: {
        trials: 45,
        patients: "2,800+",
        sites: 120
  ...
  const capabilities = [
    {
      ...
      description: "Advanced immune monitoring and biomarker assessment",
      icon: Dna
    },
    {
      title: "Global Network",
      description: "Access to specialized immunology centers worldwide",
      icon: Globe
    },
    {
      title: "Patient Monitoring",
      description: "Comprehensive immune response monitoring",
      icon: Activity
    },
    {
      title: "Data Analytics",
      description: "Sophisticated analysis of immune parameters",
      icon: BarChart
    }
  ];
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              <div className="inline-flex items-center bg-white/20 px-4 py-2 rounded-full mb-6">
                ...
                <span className="font-semibold">IMMUNOLOGY</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Immunology Clinical Research</h1>
              <p className="text-xl mb-8">
                Advancing immunological treatments through innovative clinical trials
              </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { number: "220+", label: "Immunology Trials", icon: FileText },
                { number: "13,000+", label: "Patients Enrolled", icon: Users },
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive experience across immunological conditions
              </p>
            </motion.div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive immunology trial management solutions
              </p>
            </motion.div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Real results from our immunology expertise in action
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  impact: "Reduced dropout rate by 40%",
                ...
                },
                {
                  ...
                  description: "Managed complex immune monitoring across 60 sites globally."
                },
                {
                  title: "Lupus Treatment Study",
                  impact: "Met enrollment 3 months early",
                  description: "Innovative recruitment strategies for challenging patient population."
                }
              ].map((study, index) => (
                <motion.div 
                  key={index}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 md:px-8 max-w-4xl">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold mb-4">Ready to Start Your Immunology Trial?</h2>
              <p className="text-xl mb-8">
                Let our expertise guide your next immunology clinical trial to success
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <motion.button 
